...
public class Exercise4Test {
    ...
    public void itoa_5() {
        ...
        assertEquals("-17777777777", Exercise4.itoa(Integer.MIN_VALUE, 8));
        assertEquals("-2147483647", Exercise4.itoa(Integer.MIN_VALUE, 10));
        assertEquals("-7fffffff", Exercise4.itoa(Integer.MIN_VALUE, 16));
        assertEquals("-zik0zj", Exercise4.itoa(Integer.MIN_VALUE, 36));
    }
